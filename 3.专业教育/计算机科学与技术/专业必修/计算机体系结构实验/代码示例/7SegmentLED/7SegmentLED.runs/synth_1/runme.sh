...
HD_PWD='C:/Users/Sam/Documents/Vivado2015/7SegmentLED/7SegmentLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentDisplay.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SevenSegmentDisplay.tcl
